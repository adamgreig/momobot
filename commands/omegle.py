...
class client(threading.Thread):
    ...
    def __init__(self, bot, id_check, id_speak):
        self.bot = bot
        ...
        while True:
            ...
            for chat in client.closed_chats:
                if chat == self.id_check:
                    ...
                    started = False
                    self.bot.say("%s * CLOSED" % self.myid)
                    return
